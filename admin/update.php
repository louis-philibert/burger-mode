...
<body>
    ...
    <div class="container admin">
        <div class="row">
            ...
            <br>
            <br>
            <form class="form" role="form" action="<?php echo 'update.php?id=' . $id; ?>" method="post" enctype="multipart/form-data" id="form-insert">
            ...
            <button type="submit" class="btn btn-success" id='btn-insert'><i class="fas fa-pencil-alt"></i> Modifier</button>
            ...
            <div class="col-sm-6">
                  <div class="img-thumbnail thumbnail-xs ">
                            <img class="card-img-top" src="<?='../images/'. $image;  ?>" alt="photo">
